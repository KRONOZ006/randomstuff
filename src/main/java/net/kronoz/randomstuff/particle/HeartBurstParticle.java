...
public class HeartBurstParticle extends SpriteBillboardParticle {
    ...
    public HeartBurstParticle(
        ...
        this.brightnessModifier = (float) brightnessModifier * 0.8f;
                this.maxAge = 10;
        ...
        if (alive) {
            ...
            if (bodyLightHandle == null || !bodyLightHandle.isValid()) {
                ...
                bodyLight = new PointLightData()
                        .setBrightness(BODY_LIGHT_BRIGHTNESS * this.brightnessModifier * 3)
                        .setColor(BODY_R, BODY_G, BODY_B )
                        .setRadius(BODY_LIGHT_RADIUS * this.brightnessModifier)
                ...
                float brightness = MathHelper.lerp(lifeProgress, BODY_LIGHT_BRIGHTNESS * this.brightnessModifier * 3, 1f);
               ...
               float radius = MathHelper.lerp(lifeProgress, BODY_LIGHT_RADIUS * this.brightnessModifier, 2f);
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType parameters, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            return new HeartBurstParticle(world, x, y, z, this.spriteProvider, velocityX, velocityY, velocityZ);
        }
    }
}
